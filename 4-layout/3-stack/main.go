...
func render(gtx layout.Context) {
	layout.Stack{}.Layout(gtx,
		layout.Expanded(FillBox{Color: color.NRGBA{R: 0xFF, G: 0xEE, B: 0xEE, A: 0xFF}}.Layout),
		layout.Stacked(func(gtx layout.Context) layout.Dimensions {
			return layout.NE.Layout(gtx, func(gtx layout.Context) layout.Dimensions { return layout.Dimensions{} })
		}),
	)
}
